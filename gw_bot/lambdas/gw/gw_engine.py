...
class Glasswall:
    ...
    def GWDetermineFileTypeFromFileAndReport(self, filePath):
        ...
        # API Call
        gwReturn.enumValue = self.gwLibrary.GWDetermineFileTypeFromFileAndReport(ct_filePath,
                                                                                 ct.byref(ct_analysisFileBuffer),
                                                                                 ct.byref(ct_analysisFileBufferLength))
    ...
    def GWDetermineFileTypeFromFileInMem(self, inputFileBuffer):
        ...
        # API Call
        gwReturn.enumValue = self.gwLibrary.GWDetermineFileTypeFromFileInMem(ct.byref(ct_inputFileBuffer),
                                                                             ct_inputFileBufferLength)
    ...
    def GWDetermineFileTypeFromFileInMemAndReport(self, inputFileBuffer):
        ...
        # API Call
        gwReturn.enumValue = self.gwLibrary.GWDetermineFileTypeFromFileInMemAndReport(ct.byref(ct_inputFileBuffer),
                                                                                      ct_inputFileBufferLength,
                                                                                      ct.byref(ct_analysisFileBuffer),
                                                                                      ct.byref(
                                                                                          ct_analysisFileBufferLength))
