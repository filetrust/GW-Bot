...
class test_saas_vps(Test_Helper):
    ...
    def test__invoke_directy__glasswall(self):
        ...
        assert self.result['statusCode'] == 200
        assert 'Unparalleled Protection from Advanced Persistent Threats' in self.result['body']
    ...
    def test_invoke_directly_with_payload(self):
        payload = {
            ...
            'headers': {
                ...
                'accept-language': (
                    'en-GB,en;q=0.9,pt-PT;q=0.8,pt;q=0.7,en-US;q=0.6'
                ),
                'Host': 'gw-proxy.com',
                ...
                'X-Amzn-Trace-Id': 'Root=1-5e48be59-9bbf9c36970c2c503b01ae20',
                'X-Forwarded-For': '82.39.36.190',
            ...
            'stageVariables': None,
            'requestContext': {
                'resourceId': 'g72apoktf2',
                'resourcePath': '/',
                'httpMethod': 'GET',
                'extendedRequestId': 'H-KuBFP3joEFiuQ=',
                'requestTime': '16/Feb/2020:04:00:25 +0000',
                'path': '/',
                'accountId': '311800962295',
                'protocol': 'HTTP/1.1',
                'stage': 'Prod',
                'domainPrefix': 'gw-proxy',
                'requestTimeEpoch': 1581825625683,
                'requestId': '3ff4b3e5-5503-4750-9ef5-cf61b888d552',
                'identity': {
                    'cognitoIdentityPoolId': None,
                    'accountId': None,
                    'cognitoIdentityId': None,
                    'caller': None,
                    'sourceIp': '82.39.36.190',
                    'principalOrgId': None,
                    'accessKey': None,
        ...
        assert self.result['statusCode'] == 200
        assert 'Glasswall File Drop' in self.result['body']
    ...
    def test_invoke_directly__GET_root_path(self):
        ...
        assert self.result['statusCode'] == 200
        assert '404 Not Found' in self.result['body']
